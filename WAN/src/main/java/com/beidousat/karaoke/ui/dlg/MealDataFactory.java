            ...
            case Meal.SONG:
                for (Package pack : packages) {
                    if (pack.getPackType() == Meal.SONG) {
                        meals.add(new Meal(pack.getPackType(), pack.getPackCount(), pack.getSubTotal(), pack.getRealPrice(), KBoxInfo.getInstance().getKBox().getUse_online(), KBoxInfo.getInstance().getKBox().getUse_coin(),pack.getUsec_card(),pack.getUser_card_msg(), KBoxInfo.getInstance().getKBox().getCoin_exchange_rate()));
                    }
                }
                break;
            case Meal.TIME:
