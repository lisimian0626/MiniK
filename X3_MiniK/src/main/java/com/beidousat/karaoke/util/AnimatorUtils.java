...
public class AnimatorUtils {
    ...
    private static View addAnimatorView(ViewGroup parent,float x,float y) {
    ...
    public static void playParabolaAnimator(ViewGroup parent, View target,float x,float y) {
        View view = addAnimatorView(parent,x,y);
