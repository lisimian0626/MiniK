...
public class Config {
    ...
    // 访问的endpoint地址
    public static final String endpoint = "http://media.imtbox.com";
    //callback 测试地址
    ...
    public static final String STSSERVER = "http://sts.imtbox.com";//STS 地址

    public static final String uploadFilePath = ""; //本地文件上传地址
    public static final String bucket = "ktv-media";
