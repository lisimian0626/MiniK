...
public class AdBenefitGetter extends AdGetter {
     ...
     * 获取公益视频广告
     */
    public void getBenefitVideo(String area) {
        getBenefit("Y1", PrefData.getRoomCode(mContext), area);
    }

    /**
     * 获取屏保公益广告
     */
    public void getBenefitScreen(String roomCode, String area) {
        getBenefit("Y2", roomCode, area);
    }
     ...
     *                 Y2:墙面板屏保：未开房前一直播放
     */
    private void getBenefit(String position, String roomCode, String area) {
