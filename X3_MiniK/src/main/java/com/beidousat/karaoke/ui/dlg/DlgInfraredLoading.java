...
public class DlgInfraredLoading extends BaseDialog implements OnClickListener {

    private final String TAG = DlgInfraredLoading.class.getSimpleName();
    private ProgressBar mProgress;
    private TextView mTvMsg,mTvError;
    private Button button;
    private View.OnClickListener mPositiveListener;
    private String error;
    public DlgInfraredLoading(Activity context) {
    ...
    void init() {
        ...
        RecyclerImageView imageView=(RecyclerImageView)findViewById(R.id.riv_close);
