...
public class SdSingerImageInit implements SimpleDownloadListener {
    ...
    private void downloadZip() {
        ...
        simpleDownloader.download(mZipFile, ServerConfigData.getInstance().getServerConfig().getVod_server() + "data/Img/SingerImg150.zip", this);
        Log.d("test","downloadZip:"+ServerConfigData.getInstance().getServerConfig().getVod_server() + "data/Img/SingerImg150.zip");
