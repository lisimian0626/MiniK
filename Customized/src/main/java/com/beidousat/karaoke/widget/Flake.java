...
public class Flake {
     ...
     */
    static Flake createFlake(Context context, float xRange, Bitmap originalBitmap) {
        Flake flake = new Flake();
        // Size each flake with a width between 5 and 55 and a proportional height
        flake.width = (int) (DensityUtil.dip2px(context, 12) + (float) Math.random() * DensityUtil.dip2px(context, 20));
        ...
        flake.speed = DensityUtil.dip2px(context, 20) + (float) Math.random() * 60;
