...
//            System.out.println("url " + mUrl);
            Logger.d("DownloadThread", "download url:" + mUrl);
...
//            System.out.println("code " + urlConnection.getResponseCode() + " " + mUrl);
            Logger.d("DownloadThread", "download code:" + urlConnection.getResponseCode() + " " + mUrl);
...
//            System.out.println("down ========errot============+++= " + e.getMessage());
            Logger.d("DownloadThread", "down ========errot============+++= " + e.getMessage());
