...
import com.beidousat.karaoke.player.nocache.BnsPlayer;
import com.beidousat.libbns.util.Logger;
import com.beidousat.libbns.util.ServerFileUtil;

public class DlgPreview extends Dialog implements OnClickListener, BnsPlayerListener {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mMediaPlayer.setBnsPlayerListener(DlgPreview.this);
