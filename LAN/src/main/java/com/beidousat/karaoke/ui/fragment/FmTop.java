...
public class FmTop extends BaseFragment implements AdtTopType.OnTopTypeSelectListener, OnPageScrollListener, OnSongSelectListener, OnPreviewSongListener {
    ...
    private void init() {
        ...
        int[] resId = new int[]{R.drawable.selector_top_total, R.drawable.selector_top_month, R.drawable.selector_top_day, R.drawable.selector_top_mandarin, R.drawable.selector_top_cantonese};
