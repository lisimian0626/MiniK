...
public class MarqueeGetter implements HttpRequestListener {
    ...
    public void getMarquee(String position, String songId) {
        HttpRequest r = initRequest(RequestMethod.GET_MARQUEE);
//        r.addParam("RoomCode", roomDetail == null || TextUtils.isEmpty(roomDetail.RoomCode) ? "B0" : roomDetail.RoomCode);
    ...
    public void getMarquee(String position) {
        HttpRequest r = initRequest(RequestMethod.GET_MARQUEE);
//        r.addParam("RoomCode", roomDetail == null || TextUtils.isEmpty(roomDetail.RoomCode) ? "B0" : roomDetail.RoomCode);
        r.addParam("ADPosition", position);
        r.setConvert2Token(new TypeToken<List<Ad>>() {
