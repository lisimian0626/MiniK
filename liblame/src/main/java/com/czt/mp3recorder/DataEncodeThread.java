...
//	private FileOutputStream mFileOutputStream;
	 ...
	 */
	public DataEncodeThread(File file, int bufferSize, int channel) throws FileNotFoundException {
...
//			short[] buffer = task.getData();
			...
			short[] leftrigthpcmbuf=null;
			int encodedSize =
					LameUtil.encode2(buffer, readSize, mMp3Buffer, channel);
//			 LameUtil.encode(buffer, buffer, readSize, mMp3Buffer, leftrigthpcmbuf,channel);
			if (encodedSize > 0){
				try {
