 ...
 */
public class HorizontalDividerItemDecoration2 extends FlexibleDividerDecoration {

    private MarginProvider mMarginProvider;

    protected HorizontalDividerItemDecoration2(Builder builder) {
        super(builder);
...
//        outRect.set(0, 0, 0, getDividerSize(position, parent));
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public HorizontalDividerItemDecoration2 build() {
            checkBuilderParams();
            return new HorizontalDividerItemDecoration2(this);
        }
    }
}