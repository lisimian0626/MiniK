package com.beidousat.libwidget.recycler;
 ...
 */
public class VerticalDividerItemDecoration2 extends FlexibleDividerDecoration {

    private MarginProvider mMarginProvider;

    protected VerticalDividerItemDecoration2(Builder builder) {
        super(builder);
    ...
    protected void setItemOffsets(Rect outRect, int position, RecyclerView parent) {
        if (position % 2 != 0) {
            outRect.set(getDividerSize(position, parent) / 2, 0, 0, 0);
        } else {
            outRect.set(0, 0, getDividerSize(position, parent) / 2, 0);
        }
    }
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public VerticalDividerItemDecoration2 build() {
            checkBuilderParams();
            return new VerticalDividerItemDecoration2(this);
        }
    }
}